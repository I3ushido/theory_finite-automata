...
class App(QWidget):
    ...
    def __init__(self):
        ...
        self.pic_loop0 = QPixmap('ac_01b.png')
        ...
        # self.pic_loop1 = QPixmap('ac_01b.png')
    ...
    def get_text(self):
        try:
            ...
            if total == 1 and datas[0] == "0":
                ...
                self.pic_node2 = QPixmap('n_q2r.png')
                self.label_node2.setPixmap(self.pic_node2)
...
##            self.string_result.setStyleSheet('color : red')
    ...
    def result_error_00(self):
        ...
        self.pic_node3 = QPixmap('n_q3r.png')
        self.label_node3.setPixmap(self.pic_node3)
    ...
    def start_with_1(self):
        ...
        self.pic_node = QPixmap('n_q1r.png')
        self.label_node.setPixmap(self.pic_node)
    ...
    def age_loop_last_0(self):
        ...
        self.set_fa()
        self.string_node.setText('Node : Node Q3   ')
        self.pic_loop0 = QPixmap('ac_0r1b.png')
        self.label_loop0.setPixmap(self.pic_loop0)
        self.pic_node3 = QPixmap('n_q3r.png')
        self.label_node3.setPixmap(self.pic_node3)
        self.data_has_00()
    ...
    def age_loop_last_1(self):
        ...
        self.pic_node3 = QPixmap('n_q3r.png')
        self.label_node3.setPixmap(self.pic_node3)
        self.pic_loop0 = QPixmap('ac_0b1r.png')
        self.label_loop0.setPixmap(self.pic_loop0)
        self.data_has_00()
