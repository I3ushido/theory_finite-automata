...
class App(QWidget):
    ...
    def __init__(self):
        ...
        # todo 26
        # Label Node
        self.string_node = QLabel(self)
        self.string_node.setFont(newFont1)
        self.string_node.setText("Node :                       ")

        self.string_node.move(10, 420)
        ...
        self.pic_start_node = QPixmap("assets/n_q0.png")
        ...
        self.pic_node = QPixmap("assets/n_q1.png")
        ...
        self.pic_node2 = QPixmap("assets/n_q2.png")
        ...
        self.pic_node3 = QPixmap("assets/n_q3.png")
        ...
        self.pic_line = QPixmap("assets/Arrow_black1.png")
        ...
        self.pic_age02 = QPixmap("assets/ar_b150.png")
        ...
        self.pic_age23 = QPixmap("assets/ar_b150.png")
    ...
    def get_text(self):
        try:
            ...
            if total == 1 and datas[0] == "0":
                print("This 0")
                self.string_status.setText("Status : Stopped..")
                self.string_status.setStyleSheet("color : red")
                self.pic_node2 = QPixmap("assets/n_q2r.png")
                self.label_node2.setPixmap(self.pic_node2)
                self.pic_age02 = QPixmap("assets/ar_r100.png")
                self.label_age02.setPixmap(self.pic_age02)
                self.string_result.setText("This 0 Programe Stop .. Node Q2")
                self.string_node.setText("Node : Node 2                     ")
        ...
        try:
            ...
            for semi in range(len(data) - 1):
                ...
                if data[semi] == "0" and data[semi + 1] == "0":
                    ...
                    self.string_result.setText(
                        "OMG!! Teacher X We found Data has is 00"
                    )
                    self.string_result.setStyleSheet("color : red")
                    self.data_has_00()
                    self.no()
    ...
    def clear_data(self):
        ...
        datas = ""
        self.string_node.setText("Node :                       ")
        self.string_node.setStyleSheet("color : black")
        seen = False
        i = 0
        status_zero = False
    ...
    def process_stop(self):
        ...
        self.string_status.setText("Status : Stopped..")
        self.string_status.setStyleSheet("color : red")
        self.string_node.setStyleSheet("color : red")
    ...
    def result_error_00(self):
        ...
        self.pic_node3 = QPixmap("assets/n_q3r.png")
        self.label_node3.setPixmap(self.pic_node3)
        self.pic_age23 = QPixmap("assets/ar_r100.png")
        self.label_age23.setPixmap(self.pic_age23)
        self.string_result.setText("Data has 00 Node")
        self.string_result.setStyleSheet("color : red")
        self.process_stop()
        self.no()
    ...
    def result_error_not_found_01(self):
        ...
        self.string_result.setText("Data not found 1 Node")
        self.string_result.setStyleSheet("color : red")
        self.process_stop()
        self.no()
    ...
    def start_with_0(self):
        self.set_fa()
        print("start_with_0")
        self.string_node.setText("Node : Node Q2  ")
        self.pic_node2 = QPixmap("assets/n_q2r.png")
        self.label_node2.setPixmap(self.pic_node2)
        self.pic_age02 = QPixmap("assets/ar_r100.png")
        self.label_age02.setPixmap(self.pic_age02)
    ...
    def start_with_1(self):
        print("start_with_1")
        self.string_node.setText("Node : Node Q1   ")
        self.pic_node = QPixmap("assets/n_q1r.png")
        self.label_node.setPixmap(self.pic_node)
        self.pic_age01 = QPixmap("assets/ar_r50.png")
        self.label_age01.setPixmap(self.pic_age01)

    def yes(self):
        print("Yes")
        self.pix_photo = QPixmap("assets/yes.jpg")
        self.photo.setPixmap(self.pix_photo)
        self.button_next.setEnabled(False)
    ...
    def age_node211_red(self):
        ...
        self.pic_node = QPixmap("assets/n_q1r.png")
        self.label_node.setPixmap(self.pic_node)
        self.pic_age211 = QPixmap("assets/a45_1r.png")
        self.label_age211.setPixmap(self.pic_age211)
    ...
    def age_node120_red(self):
        ...
        self.pic_node2 = QPixmap("assets/n_q2r.png")
        self.label_node2.setPixmap(self.pic_node2)
        self.pic_age120 = QPixmap("assets/a45_0r.png")
        self.label_age120.setPixmap(self.pic_age120)
    ...
    def age_self_loop_1(self):
        ...
        self.pic_node = QPixmap("assets/n_q1r.png")
        self.label_node.setPixmap(self.pic_node)
        self.pic_start_self = QPixmap("assets/ac_1r.png")
        self.label_start_self.setPixmap(self.pic_start_self)
    ...
    def age_loop_last_1(self):
        ...
        self.pic_node3 = QPixmap("assets/n_q3r.png")
        self.label_node3.setPixmap(self.pic_node3)
        self.pic_loop0 = QPixmap("assets/ac_0b1r.png")
        self.label_loop0.setPixmap(self.pic_loop0)
        self.data_has_00()
