    ...
    def step(self):
        ...
        try:
            ...
            try:
                ...
                ###############################################
                if total >= 1 and datas[0] == '0' and datas[1] == '1':
                    self.start_with_0()
                ###############################################
                ...
                # may be bug
                if total >= 1 and datas[0] == '1' and i == 0:
                    self.start_with_1()

                if total >= 1 and datas[0] == '0' and datas[i] == '1' and i == 1:
                ...
                # Last 11
                if i >= 1 and i == total - 1 and datas[i] == '1' and datas[i - 1] == '1':
                    print('i == total - 1 and datas[i] == 1')
                    self.age_self_loop_1()
                    self.result_correct()
                # Last 01
                if i >= 1 and i == total - 1 and datas[i] == '1' and datas[i - 1] == '0':
                    print('i == total - 1 and datas[i] == 1')
                    self.age_node211_red()
                    self.result_correct()
